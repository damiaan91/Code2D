 ...
 */
public class C2Plugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "nl.utwente.apc.Code2D.resource.c2";
	/**
	...
	private static C2Plugin plugin;
	...
	public static C2Plugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, C2Plugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, C2Plugin.PLUGIN_ID, message);
		}
		final C2Plugin pluginInstance = C2Plugin.getDefault();
