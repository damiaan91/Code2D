...
/**
 * C2LayoutInformation objects are used to store layout information that is found
 ...
 * C2LayoutInformations are aggregated in LayoutInformationAdapters. One
 * C2LayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class C2LayoutInformation {
	 ...
	 */
	private final nl.utwente.apc.Code2D.resource.c2.grammar.C2SyntaxElement syntaxElement;
	...
	public C2LayoutInformation(nl.utwente.apc.Code2D.resource.c2.grammar.C2SyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public nl.utwente.apc.Code2D.resource.c2.grammar.C2SyntaxElement getSyntaxElement() {
