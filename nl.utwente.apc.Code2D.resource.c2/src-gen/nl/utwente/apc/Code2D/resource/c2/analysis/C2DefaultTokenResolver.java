 ...
 */
public class C2DefaultTokenResolver implements nl.utwente.apc.Code2D.resource.c2.IC2TokenResolver {
	 ...
	 */
	public C2DefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, nl.utwente.apc.Code2D.resource.c2.IC2TokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : nl.utwente.apc.Code2D.resource.c2.grammar.C2GrammarInformationProvider.INSTANCE.getKeywords()) {
