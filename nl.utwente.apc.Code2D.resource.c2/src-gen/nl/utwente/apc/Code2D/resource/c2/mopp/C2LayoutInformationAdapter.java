...
/**
 * A C2LayoutInformationAdapter is used to store layout information that is found
 ...
 * C2LayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class C2LayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<nl.utwente.apc.Code2D.resource.c2.mopp.C2LayoutInformation> layoutInformations = new java.util.ArrayList<nl.utwente.apc.Code2D.resource.c2.mopp.C2LayoutInformation>();
	...
	public java.util.List<nl.utwente.apc.Code2D.resource.c2.mopp.C2LayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(nl.utwente.apc.Code2D.resource.c2.mopp.C2LayoutInformation layoutInformation) {
