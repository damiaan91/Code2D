...
public class C2StackFrame extends nl.utwente.apc.Code2D.resource.c2.debug.C2DebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private nl.utwente.apc.Code2D.resource.c2.debug.C2DebugTarget target;
	private String name;
	private int id;
	...
	public C2StackFrame(nl.utwente.apc.Code2D.resource.c2.debug.C2DebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = nl.utwente.apc.Code2D.resource.c2.util.C2StringUtil.decode(data, ',');
	...
	private nl.utwente.apc.Code2D.resource.c2.debug.C2DebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		nl.utwente.apc.Code2D.resource.c2.debug.C2StackFrame other = (nl.utwente.apc.Code2D.resource.c2.debug.C2StackFrame) obj;
		if (name == null) {
