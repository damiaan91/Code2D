 ...
 * resolver
 */
public interface IC2ReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends nl.utwente.apc.Code2D.resource.c2.IC2Configurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, nl.utwente.apc.Code2D.resource.c2.IC2ReferenceResolveResult<ReferenceType> result);
