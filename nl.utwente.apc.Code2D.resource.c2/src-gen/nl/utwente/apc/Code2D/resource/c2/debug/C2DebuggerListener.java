 ...
 * code).
 */
public class C2DebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private nl.utwente.apc.Code2D.resource.c2.debug.AbstractC2Debuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, nl.utwente.apc.Code2D.resource.c2.util.C2Pair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, nl.utwente.apc.Code2D.resource.c2.util.C2Pair<String, Object>>();
	...
	public C2DebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		nl.utwente.apc.Code2D.resource.c2.debug.C2DebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(nl.utwente.apc.Code2D.resource.c2.debug.EC2DebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(nl.utwente.apc.Code2D.resource.c2.debug.EC2DebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(nl.utwente.apc.Code2D.resource.c2.debug.EC2DebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(nl.utwente.apc.Code2D.resource.c2.debug.EC2DebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(nl.utwente.apc.Code2D.resource.c2.debug.EC2DebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(nl.utwente.apc.Code2D.resource.c2.debug.EC2DebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(nl.utwente.apc.Code2D.resource.c2.debug.EC2DebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(nl.utwente.apc.Code2D.resource.c2.debug.EC2DebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = nl.utwente.apc.Code2D.resource.c2.util.C2StringUtil.encode('#', stack);
				nl.utwente.apc.Code2D.resource.c2.debug.C2DebugMessage message = new nl.utwente.apc.Code2D.resource.c2.debug.C2DebugMessage(nl.utwente.apc.Code2D.resource.c2.debug.EC2DebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(nl.utwente.apc.Code2D.resource.c2.debug.EC2DebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				nl.utwente.apc.Code2D.resource.c2.debug.C2DebugMessage message = new nl.utwente.apc.Code2D.resource.c2.debug.C2DebugMessage(nl.utwente.apc.Code2D.resource.c2.debug.EC2DebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(nl.utwente.apc.Code2D.resource.c2.debug.EC2DebugMessageTypes.GET_VARIABLES)) {
				...
				nl.utwente.apc.Code2D.resource.c2.debug.C2DebugMessage message = new nl.utwente.apc.Code2D.resource.c2.debug.C2DebugMessage(nl.utwente.apc.Code2D.resource.c2.debug.EC2DebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return nl.utwente.apc.Code2D.resource.c2.util.C2StringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		nl.utwente.apc.Code2D.resource.c2.util.C2Pair<String, Object> pair = new nl.utwente.apc.Code2D.resource.c2.util.C2Pair<String, Object>(name, value);
	...
	public nl.utwente.apc.Code2D.resource.c2.debug.AbstractC2Debuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(nl.utwente.apc.Code2D.resource.c2.debug.AbstractC2Debuggable debuggable) {
