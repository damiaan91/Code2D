...
public class C2Nature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "nl.utwente.apc.Code2D.resource.c2.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {nl.utwente.apc.Code2D.resource.c2.mopp.C2BuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(nl.utwente.apc.Code2D.resource.c2.mopp.C2BuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
