...
public class C2LayoutUtil {
	...
	public void transferLayoutInformationToModel(org.eclipse.emf.ecore.EObject element) {
		...
		for (java.util.Iterator<nl.utwente.apc.Code2D.resource.c2.mopp.C2LayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			nl.utwente.apc.Code2D.resource.c2.mopp.C2LayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(org.eclipse.emf.ecore.EObject element) {
		...
		if (layoutReference != null) {
			...
			for (java.util.Iterator<org.eclipse.emf.ecore.EObject> i = list.iterator(); i.hasNext(); ) {
				...
				nl.utwente.apc.Code2D.resource.c2.mopp.C2LayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public org.eclipse.emf.ecore.EObject createLayoutInformationModelElement(nl.utwente.apc.Code2D.resource.c2.mopp.C2LayoutInformation layoutInformation, org.eclipse.emf.ecore.EPackage layoutPackage) {
		...
		nl.utwente.apc.Code2D.resource.c2.grammar.C2SyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), nl.utwente.apc.Code2D.resource.c2.grammar.C2GrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public nl.utwente.apc.Code2D.resource.c2.mopp.C2LayoutInformation createLayoutInformation(org.eclipse.emf.ecore.EObject layoutInformationModelElement) {
		Object object = null;
		...
		nl.utwente.apc.Code2D.resource.c2.grammar.C2SyntaxElement syntaxElement = nl.utwente.apc.Code2D.resource.c2.grammar.C2GrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof nl.utwente.apc.Code2D.resource.c2.grammar.C2Placeholder) {
			nl.utwente.apc.Code2D.resource.c2.grammar.C2Placeholder placeholder = (nl.utwente.apc.Code2D.resource.c2.grammar.C2Placeholder) syntaxElement;
			nl.utwente.apc.Code2D.resource.c2.IC2TokenResolver tokenResolver = new nl.utwente.apc.Code2D.resource.c2.mopp.C2TokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			nl.utwente.apc.Code2D.resource.c2.IC2TokenResolveResult result = new nl.utwente.apc.Code2D.resource.c2.mopp.C2TokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new nl.utwente.apc.Code2D.resource.c2.mopp.C2LayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public nl.utwente.apc.Code2D.resource.c2.mopp.C2LayoutInformationAdapter getLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
