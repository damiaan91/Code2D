 ...
 */
public class AbstractC2Interpreter<ResultType, ContextType> {
	
	private java.util.Stack<org.eclipse.emf.ecore.EObject> interpretationStack = new java.util.Stack<org.eclipse.emf.ecore.EObject>();
	private java.util.List<nl.utwente.apc.Code2D.resource.c2.IC2InterpreterListener> listeners = new java.util.ArrayList<nl.utwente.apc.Code2D.resource.c2.IC2InterpreterListener>();
	...
	private void notifyListeners(org.eclipse.emf.ecore.EObject element) {
		for (nl.utwente.apc.Code2D.resource.c2.IC2InterpreterListener listener : listeners) {
	...
	public void addListener(nl.utwente.apc.Code2D.resource.c2.IC2InterpreterListener newListener) {
		listeners.add(newListener);
	}
	
	public boolean removeListener(nl.utwente.apc.Code2D.resource.c2.IC2InterpreterListener listener) {
