...
public class C2RuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			nl.utwente.apc.Code2D.resource.c2.mopp.C2Plugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			nl.utwente.apc.Code2D.resource.c2.mopp.C2Plugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
