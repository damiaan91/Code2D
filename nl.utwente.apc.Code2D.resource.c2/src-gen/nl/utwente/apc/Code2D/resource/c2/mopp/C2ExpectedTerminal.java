 ...
 */
public class C2ExpectedTerminal {
	...
	private nl.utwente.apc.Code2D.resource.c2.IC2ExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	private nl.utwente.apc.Code2D.resource.c2.grammar.C2ContainmentTrace containmentTrace;
	
	public C2ExpectedTerminal(org.eclipse.emf.ecore.EObject container, nl.utwente.apc.Code2D.resource.c2.IC2ExpectedElement terminal, int followSetID, nl.utwente.apc.Code2D.resource.c2.grammar.C2ContainmentTrace containmentTrace) {
		super();
	...
	public nl.utwente.apc.Code2D.resource.c2.IC2ExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		...
		C2ExpectedTerminal otherExpectedTerminal = (C2ExpectedTerminal) o;
	...
	public nl.utwente.apc.Code2D.resource.c2.grammar.C2ContainmentTrace getContainmentTrace() {
