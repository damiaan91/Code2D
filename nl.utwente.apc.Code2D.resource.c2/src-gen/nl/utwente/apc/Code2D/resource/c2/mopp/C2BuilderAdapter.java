...
public class C2BuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "nl.utwente.apc.Code2D.resource.c2.builder";
	
	private nl.utwente.apc.Code2D.resource.c2.IC2Builder defaultBuilder = new nl.utwente.apc.Code2D.resource.c2.mopp.C2Builder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		nl.utwente.apc.Code2D.resource.c2.IC2Builder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			nl.utwente.apc.Code2D.resource.c2.mopp.C2Resource customResource = (nl.utwente.apc.Code2D.resource.c2.mopp.C2Resource) resourceSet.getResource(uri, true);
			new nl.utwente.apc.Code2D.resource.c2.mopp.C2MarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public nl.utwente.apc.Code2D.resource.c2.IC2Builder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new nl.utwente.apc.Code2D.resource.c2.mopp.C2MarkerHelper().getMarkerID(nl.utwente.apc.Code2D.resource.c2.C2EProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		nl.utwente.apc.Code2D.resource.c2.mopp.C2TaskItemBuilder taskItemBuilder = new nl.utwente.apc.Code2D.resource.c2.mopp.C2TaskItemBuilder();
		new nl.utwente.apc.Code2D.resource.c2.mopp.C2MarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new nl.utwente.apc.Code2D.resource.c2.mopp.C2MetaInformation().getSyntaxName())) {
