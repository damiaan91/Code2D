...
public class C2DebugValue extends nl.utwente.apc.Code2D.resource.c2.debug.C2DebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public C2DebugValue(nl.utwente.apc.Code2D.resource.c2.debug.C2DebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
