...
public class C2dBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "nl.utwente.apc.Code2D.resource.c2d.builder";
	
	private nl.utwente.apc.Code2D.resource.c2d.IC2dBuilder defaultBuilder = new nl.utwente.apc.Code2D.resource.c2d.mopp.C2dBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		nl.utwente.apc.Code2D.resource.c2d.IC2dBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			nl.utwente.apc.Code2D.resource.c2d.mopp.C2dResource customResource = (nl.utwente.apc.Code2D.resource.c2d.mopp.C2dResource) resourceSet.getResource(uri, true);
			new nl.utwente.apc.Code2D.resource.c2d.mopp.C2dMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public nl.utwente.apc.Code2D.resource.c2d.IC2dBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new nl.utwente.apc.Code2D.resource.c2d.mopp.C2dMarkerHelper().getMarkerID(nl.utwente.apc.Code2D.resource.c2d.C2dEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		nl.utwente.apc.Code2D.resource.c2d.mopp.C2dTaskItemBuilder taskItemBuilder = new nl.utwente.apc.Code2D.resource.c2d.mopp.C2dTaskItemBuilder();
		new nl.utwente.apc.Code2D.resource.c2d.mopp.C2dMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new nl.utwente.apc.Code2D.resource.c2d.mopp.C2dMetaInformation().getSyntaxName())) {
