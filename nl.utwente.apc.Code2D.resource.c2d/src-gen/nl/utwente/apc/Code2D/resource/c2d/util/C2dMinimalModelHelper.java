 ...
 */
public class C2dMinimalModelHelper {
	
	private final static nl.utwente.apc.Code2D.resource.c2d.util.C2dEClassUtil eClassUtil = new nl.utwente.apc.Code2D.resource.c2d.util.C2dEClassUtil();
			...
			if (feature instanceof org.eclipse.emf.ecore.EReference) {
				...
				if (type instanceof org.eclipse.emf.ecore.EClass) {
					...
					for (int i = 0; i < lowerBound; i++) {
						...
						if (reference.isContainment()) {
							...
							String initialValue = "#some" + nl.utwente.apc.Code2D.resource.c2d.util.C2dStringUtil.capitalize(typeClass.getName());
						...
						if (value instanceof java.util.List<?>) {
							java.util.List<org.eclipse.emf.ecore.EObject> list = nl.utwente.apc.Code2D.resource.c2d.util.C2dListUtil.castListUnchecked(value);
							list.add(subModel);
						} else {
				...
				if ("EString".equals(attribute.getEType().getName())) {
					...
					if (attribute.getName().equals("name") && name != null) {
						...
						initialValue = "some" + nl.utwente.apc.Code2D.resource.c2d.util.C2dStringUtil.capitalize(attribute.getName());
					}
					Object value = root.eGet(attribute);
					if (value instanceof java.util.List<?>) {
						java.util.List<String> list = nl.utwente.apc.Code2D.resource.c2d.util.C2dListUtil.castListUnchecked(value);
