 ...
 * delegates.
 */
public class C2dLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends nl.utwente.apc.Code2D.resource.c2d.util.AbstractC2dInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, nl.utwente.apc.Code2D.resource.c2d.util.AbstractC2dInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebuggableInterpreter<ResultType, ContextType> interpreter = new nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebuggerListener<ResultType, ContextType> debugListener = new nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebugProcess process = new nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebugProcess(launch);
		launch.addDebugTarget(new nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(nl.utwente.apc.Code2D.resource.c2d.launch.C2dLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return nl.utwente.apc.Code2D.resource.c2d.util.C2dResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, nl.utwente.apc.Code2D.resource.c2d.mopp.C2dPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
