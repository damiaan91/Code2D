...
public class C2dRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			nl.utwente.apc.Code2D.resource.c2d.mopp.C2dPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			nl.utwente.apc.Code2D.resource.c2d.mopp.C2dPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
