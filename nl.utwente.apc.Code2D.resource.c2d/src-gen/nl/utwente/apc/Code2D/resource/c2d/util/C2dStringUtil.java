...
public class C2dStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, nl.utwente.apc.Code2D.resource.c2d.IC2dFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, nl.utwente.apc.Code2D.resource.c2d.IC2dFunction1<String, T> toStringFunction) {
