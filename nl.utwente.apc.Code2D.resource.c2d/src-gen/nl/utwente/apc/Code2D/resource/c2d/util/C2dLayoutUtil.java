...
public class C2dLayoutUtil {
	...
	public void transferLayoutInformationToModel(org.eclipse.emf.ecore.EObject element) {
		...
		for (java.util.Iterator<nl.utwente.apc.Code2D.resource.c2d.mopp.C2dLayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			nl.utwente.apc.Code2D.resource.c2d.mopp.C2dLayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(org.eclipse.emf.ecore.EObject element) {
		...
		if (layoutReference != null) {
			...
			for (java.util.Iterator<org.eclipse.emf.ecore.EObject> i = list.iterator(); i.hasNext(); ) {
				...
				nl.utwente.apc.Code2D.resource.c2d.mopp.C2dLayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public org.eclipse.emf.ecore.EObject createLayoutInformationModelElement(nl.utwente.apc.Code2D.resource.c2d.mopp.C2dLayoutInformation layoutInformation, org.eclipse.emf.ecore.EPackage layoutPackage) {
		...
		nl.utwente.apc.Code2D.resource.c2d.grammar.C2dSyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), nl.utwente.apc.Code2D.resource.c2d.grammar.C2dGrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public nl.utwente.apc.Code2D.resource.c2d.mopp.C2dLayoutInformation createLayoutInformation(org.eclipse.emf.ecore.EObject layoutInformationModelElement) {
		Object object = null;
		...
		nl.utwente.apc.Code2D.resource.c2d.grammar.C2dSyntaxElement syntaxElement = nl.utwente.apc.Code2D.resource.c2d.grammar.C2dGrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof nl.utwente.apc.Code2D.resource.c2d.grammar.C2dPlaceholder) {
			nl.utwente.apc.Code2D.resource.c2d.grammar.C2dPlaceholder placeholder = (nl.utwente.apc.Code2D.resource.c2d.grammar.C2dPlaceholder) syntaxElement;
			nl.utwente.apc.Code2D.resource.c2d.IC2dTokenResolver tokenResolver = new nl.utwente.apc.Code2D.resource.c2d.mopp.C2dTokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			nl.utwente.apc.Code2D.resource.c2d.IC2dTokenResolveResult result = new nl.utwente.apc.Code2D.resource.c2d.mopp.C2dTokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new nl.utwente.apc.Code2D.resource.c2d.mopp.C2dLayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public nl.utwente.apc.Code2D.resource.c2d.mopp.C2dLayoutInformationAdapter getLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
