...
public class C2dDebugValue extends nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public C2dDebugValue(nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
