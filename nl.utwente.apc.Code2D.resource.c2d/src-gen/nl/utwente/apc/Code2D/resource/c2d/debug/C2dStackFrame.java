...
public class C2dStackFrame extends nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebugTarget target;
	private String name;
	private int id;
	...
	public C2dStackFrame(nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = nl.utwente.apc.Code2D.resource.c2d.util.C2dStringUtil.decode(data, ',');
	...
	private nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		nl.utwente.apc.Code2D.resource.c2d.debug.C2dStackFrame other = (nl.utwente.apc.Code2D.resource.c2d.debug.C2dStackFrame) obj;
		if (name == null) {
