 ...
 */
public interface IC2dOptions {
	
	/**
	 * The key for the option to provide a stream pre-processor.
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new nl.utwente.apc.Code2D.resource.c2d.mopp.C2dMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new nl.utwente.apc.Code2D.resource.c2d.mopp.C2dMetaInformation().getResourcePostProcessorProviderOptionKey();
