...
public class C2dLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "nl.utwente.apc.Code2D.resource.c2d.debug.lineBreakpoint.marker";
	
	public C2dLineBreakpoint() {
		super();
	}
	
	public C2dLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebugTarget target) {
		try {
	...
	public void remove(nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
