 ...
 */
public class C2dPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "nl.utwente.apc.Code2D.resource.c2d";
	/**
	...
	private static C2dPlugin plugin;
	...
	public static C2dPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, C2dPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, C2dPlugin.PLUGIN_ID, message);
		}
		final C2dPlugin pluginInstance = C2dPlugin.getDefault();
