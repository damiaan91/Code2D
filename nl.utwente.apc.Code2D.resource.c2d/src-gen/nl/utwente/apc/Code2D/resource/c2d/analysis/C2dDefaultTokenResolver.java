 ...
 */
public class C2dDefaultTokenResolver implements nl.utwente.apc.Code2D.resource.c2d.IC2dTokenResolver {
	 ...
	 */
	public C2dDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public C2dDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, nl.utwente.apc.Code2D.resource.c2d.IC2dTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : nl.utwente.apc.Code2D.resource.c2d.grammar.C2dGrammarInformationProvider.INSTANCE.getKeywords()) {
