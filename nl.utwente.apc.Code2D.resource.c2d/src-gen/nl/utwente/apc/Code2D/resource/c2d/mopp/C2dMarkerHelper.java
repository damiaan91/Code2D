 ...
 * contains <code>nl.utwente.apc.Code2D.resource.c2d.IC2dTextDiagnostic</code>s it
 * uses the more precise information of this extended diagnostic type.
 */
public class C2dMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = nl.utwente.apc.Code2D.resource.c2d.mopp.C2dPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<nl.utwente.apc.Code2D.resource.c2d.IC2dCommand<Object>> commands = new java.util.ArrayList<nl.utwente.apc.Code2D.resource.c2d.IC2dCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(nl.utwente.apc.Code2D.resource.c2d.IC2dCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<nl.utwente.apc.Code2D.resource.c2d.IC2dCommand<Object>> commandsToProcess = new java.util.ArrayList<nl.utwente.apc.Code2D.resource.c2d.IC2dCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (nl.utwente.apc.Code2D.resource.c2d.IC2dCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, nl.utwente.apc.Code2D.resource.c2d.IC2dTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final nl.utwente.apc.Code2D.resource.c2d.IC2dTextDiagnostic diagnostic) {
		final nl.utwente.apc.Code2D.resource.c2d.IC2dProblem problem = diagnostic.getProblem();
		nl.utwente.apc.Code2D.resource.c2d.C2dEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new nl.utwente.apc.Code2D.resource.c2d.IC2dCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == nl.utwente.apc.Code2D.resource.c2d.C2dEProblemSeverity.ERROR) {
					...
					nl.utwente.apc.Code2D.resource.c2d.IC2dTextDiagnostic textDiagnostic = (nl.utwente.apc.Code2D.resource.c2d.IC2dTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof nl.utwente.apc.Code2D.resource.c2d.mopp.C2dResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((nl.utwente.apc.Code2D.resource.c2d.mopp.C2dResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<nl.utwente.apc.Code2D.resource.c2d.IC2dQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, nl.utwente.apc.Code2D.resource.c2d.util.C2dStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (nl.utwente.apc.Code2D.resource.c2d.C2dEProblemType nextType : nl.utwente.apc.Code2D.resource.c2d.C2dEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, nl.utwente.apc.Code2D.resource.c2d.C2dEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(nl.utwente.apc.Code2D.resource.c2d.C2dEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(nl.utwente.apc.Code2D.resource.c2d.C2dEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new nl.utwente.apc.Code2D.resource.c2d.util.C2dRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new nl.utwente.apc.Code2D.resource.c2d.IC2dCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					nl.utwente.apc.Code2D.resource.c2d.mopp.C2dPlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
