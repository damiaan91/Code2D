...
/**
 * C2dLayoutInformation objects are used to store layout information that is found
 ...
 * C2dLayoutInformations are aggregated in LayoutInformationAdapters. One
 * C2dLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class C2dLayoutInformation {
	 ...
	 */
	private final nl.utwente.apc.Code2D.resource.c2d.grammar.C2dSyntaxElement syntaxElement;
	...
	public C2dLayoutInformation(nl.utwente.apc.Code2D.resource.c2d.grammar.C2dSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public nl.utwente.apc.Code2D.resource.c2d.grammar.C2dSyntaxElement getSyntaxElement() {
