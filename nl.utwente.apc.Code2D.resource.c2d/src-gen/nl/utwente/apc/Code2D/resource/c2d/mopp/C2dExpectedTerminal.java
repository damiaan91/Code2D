 ...
 */
public class C2dExpectedTerminal {
	...
	private nl.utwente.apc.Code2D.resource.c2d.IC2dExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	private nl.utwente.apc.Code2D.resource.c2d.grammar.C2dContainmentTrace containmentTrace;
	
	public C2dExpectedTerminal(org.eclipse.emf.ecore.EObject container, nl.utwente.apc.Code2D.resource.c2d.IC2dExpectedElement terminal, int followSetID, nl.utwente.apc.Code2D.resource.c2d.grammar.C2dContainmentTrace containmentTrace) {
		super();
	...
	public nl.utwente.apc.Code2D.resource.c2d.IC2dExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		...
		C2dExpectedTerminal otherExpectedTerminal = (C2dExpectedTerminal) o;
	...
	public nl.utwente.apc.Code2D.resource.c2d.grammar.C2dContainmentTrace getContainmentTrace() {
