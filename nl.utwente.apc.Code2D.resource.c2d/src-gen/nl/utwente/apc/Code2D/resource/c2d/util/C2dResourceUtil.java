...
public class C2dResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new nl.utwente.apc.Code2D.resource.c2d.util.C2dInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new nl.utwente.apc.Code2D.resource.c2d.util.C2dInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static nl.utwente.apc.Code2D.resource.c2d.mopp.C2dResource getResource(java.io.File file) {
	...
	public static nl.utwente.apc.Code2D.resource.c2d.mopp.C2dResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new nl.utwente.apc.Code2D.resource.c2d.mopp.C2dMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (nl.utwente.apc.Code2D.resource.c2d.mopp.C2dResource) resource;
	}
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		nl.utwente.apc.Code2D.resource.c2d.IC2dTextResource resource = (nl.utwente.apc.Code2D.resource.c2d.IC2dTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (nl.utwente.apc.Code2D.resource.c2d.IC2dTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		nl.utwente.apc.Code2D.resource.c2d.IC2dTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
