 ...
 */
public class C2dBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final nl.utwente.apc.Code2D.resource.c2d.IC2dTextResource resource, final nl.utwente.apc.Code2D.resource.c2d.ui.C2dEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final nl.utwente.apc.Code2D.resource.c2d.IC2dTextResource resource, final nl.utwente.apc.Code2D.resource.c2d.ui.C2dEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final nl.utwente.apc.Code2D.resource.c2d.IC2dTextResource resource, final nl.utwente.apc.Code2D.resource.c2d.ui.C2dEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof nl.utwente.apc.Code2D.resource.c2d.mopp.C2dResource) {
							nl.utwente.apc.Code2D.resource.c2d.mopp.C2dResource concreteResource = (nl.utwente.apc.Code2D.resource.c2d.mopp.C2dResource) resource;
