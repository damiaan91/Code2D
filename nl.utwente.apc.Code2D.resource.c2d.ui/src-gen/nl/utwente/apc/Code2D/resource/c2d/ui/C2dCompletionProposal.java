 ...
 */
public class C2dCompletionProposal implements java.lang.Comparable<C2dCompletionProposal> {
	 ...
	 */
	private nl.utwente.apc.Code2D.resource.c2d.mopp.C2dExpectedTerminal expectedTerminal;
	...
	public C2dCompletionProposal(nl.utwente.apc.Code2D.resource.c2d.mopp.C2dExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public C2dCompletionProposal(nl.utwente.apc.Code2D.resource.c2d.mopp.C2dExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public C2dCompletionProposal(nl.utwente.apc.Code2D.resource.c2d.mopp.C2dExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public nl.utwente.apc.Code2D.resource.c2d.mopp.C2dExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof C2dCompletionProposal) {
			C2dCompletionProposal other = (C2dCompletionProposal) object;
	...
	public int compareTo(C2dCompletionProposal object) {
		if (object instanceof C2dCompletionProposal) {
			C2dCompletionProposal other = (C2dCompletionProposal) object;
