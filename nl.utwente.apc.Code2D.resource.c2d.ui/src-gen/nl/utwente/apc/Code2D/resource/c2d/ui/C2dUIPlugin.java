 ...
 */
public class C2dUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "nl.utwente.apc.Code2D.resource.c2d.ui";
	public static final String EDITOR_ID = "nl.utwente.apc.Code2D.resource.c2d.ui.C2dEditor";
	...
	private static C2dUIPlugin plugin;
	...
	public static C2dUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, C2dUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, C2dUIPlugin.PLUGIN_ID, message);
		}
		final C2dUIPlugin pluginInstance = C2dUIPlugin.getDefault();
