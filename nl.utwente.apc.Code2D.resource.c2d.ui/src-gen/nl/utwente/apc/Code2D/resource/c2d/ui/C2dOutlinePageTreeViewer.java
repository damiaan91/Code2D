 ...
 * a specified depth.
 */
public class C2dOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public C2dOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = nl.utwente.apc.Code2D.resource.c2d.util.C2dStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof nl.utwente.apc.Code2D.resource.c2d.ui.C2dEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			nl.utwente.apc.Code2D.resource.c2d.mopp.C2dPlugin.logError("Exception while refreshing outline view", e);
		}
	}
