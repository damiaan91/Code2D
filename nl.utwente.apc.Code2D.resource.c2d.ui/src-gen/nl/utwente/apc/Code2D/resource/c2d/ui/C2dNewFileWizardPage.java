 ...
 */
public class C2dNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public C2dNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new c2d file");
