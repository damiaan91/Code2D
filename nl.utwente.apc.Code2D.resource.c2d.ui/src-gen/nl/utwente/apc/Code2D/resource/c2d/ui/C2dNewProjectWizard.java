 ...
 */
public class C2dNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new nl.utwente.apc.Code2D.resource.c2d.mopp.C2dMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("nl.utwente.apc.Code2D.resource.c2d.ui");
							...
							String natureID = nl.utwente.apc.Code2D.resource.c2d.mopp.C2dNature.NATURE_ID;
							...
							for (String builderID : nl.utwente.apc.Code2D.resource.c2d.mopp.C2dNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								nl.utwente.apc.Code2D.resource.c2d.mopp.C2dMetaInformation info = new nl.utwente.apc.Code2D.resource.c2d.mopp.C2dMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = nl.utwente.apc.Code2D.resource.c2d.ui.C2dUIPlugin.getDefault().getBundle();
