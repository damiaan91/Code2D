...
/**
 * A text editor for 'c2d' models.
 * <p>
 * This editor has id <code>nl.utwente.apc.Code2D.resource.c2d.ui.C2dEditor</code>
 * The editor's context menu has id
 * <code>nl.utwente.apc.Code2D.resource.c2d.EditorContext</code>.
 * The editor's ruler context menu has id
 * <code>nl.utwente.apc.Code2D.resource.c2d.EditorRuler</code>.
 * </p>
 */
public class C2dEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, nl.utwente.apc.Code2D.resource.c2d.IC2dResourceProvider, nl.utwente.apc.Code2D.resource.c2d.ui.IC2dBracketHandlerProvider, nl.utwente.apc.Code2D.resource.c2d.ui.IC2dAnnotationModelProvider {
	
	private nl.utwente.apc.Code2D.resource.c2d.ui.C2dHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private nl.utwente.apc.Code2D.resource.c2d.ui.C2dCodeFoldingManager codeFoldingManager;
	private nl.utwente.apc.Code2D.resource.c2d.ui.C2dBackgroundParsingStrategy bgParsingStrategy = new nl.utwente.apc.Code2D.resource.c2d.ui.C2dBackgroundParsingStrategy();
	private java.util.Collection<nl.utwente.apc.Code2D.resource.c2d.IC2dBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<nl.utwente.apc.Code2D.resource.c2d.IC2dBackgroundParsingListener>();
	private nl.utwente.apc.Code2D.resource.c2d.ui.C2dColorManager colorManager = new nl.utwente.apc.Code2D.resource.c2d.ui.C2dColorManager();
	private nl.utwente.apc.Code2D.resource.c2d.ui.C2dOutlinePage outlinePage;
	...
	private nl.utwente.apc.Code2D.resource.c2d.ui.C2dPropertySheetPage propertySheetPage;
	...
	private nl.utwente.apc.Code2D.resource.c2d.ui.IC2dBracketHandler bracketHandler;
	...
	public C2dEditor() {
		super();
		setSourceViewerConfiguration(new nl.utwente.apc.Code2D.resource.c2d.ui.C2dSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), C2dEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								nl.utwente.apc.Code2D.resource.c2d.IC2dTextResource currentResource = getResource();
				...
				nl.utwente.apc.Code2D.resource.c2d.ui.C2dUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("nl.utwente.apc.Code2D.resource.c2d.EditorContext");
		setRulerContextMenuId("nl.utwente.apc.Code2D.resource.c2d.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new nl.utwente.apc.Code2D.resource.c2d.ui.C2dHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new nl.utwente.apc.Code2D.resource.c2d.ui.C2dCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		nl.utwente.apc.Code2D.resource.c2d.mopp.C2dNature.activate(inputFile.getProject());
		...
		nl.utwente.apc.Code2D.resource.c2d.IC2dTextResource loadedResource = (nl.utwente.apc.Code2D.resource.c2d.IC2dTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				nl.utwente.apc.Code2D.resource.c2d.IC2dTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof nl.utwente.apc.Code2D.resource.c2d.IC2dTextResource) {
					setResource((nl.utwente.apc.Code2D.resource.c2d.IC2dTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					nl.utwente.apc.Code2D.resource.c2d.ui.C2dUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the C2dEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				nl.utwente.apc.Code2D.resource.c2d.ui.C2dUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(nl.utwente.apc.Code2D.resource.c2d.IC2dTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new nl.utwente.apc.Code2D.resource.c2d.ui.C2dOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new nl.utwente.apc.Code2D.resource.c2d.ui.C2dPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			nl.utwente.apc.Code2D.resource.c2d.IC2dTextResource textResource = (nl.utwente.apc.Code2D.resource.c2d.IC2dTextResource) element.eResource();
			...
			nl.utwente.apc.Code2D.resource.c2d.IC2dTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				nl.utwente.apc.Code2D.resource.c2d.IC2dTextToken token = lexer.getNextToken();
			...
			nl.utwente.apc.Code2D.resource.c2d.ui.C2dUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!C2dEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(nl.utwente.apc.Code2D.resource.c2d.IC2dBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (nl.utwente.apc.Code2D.resource.c2d.IC2dBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public nl.utwente.apc.Code2D.resource.c2d.ui.IC2dBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(nl.utwente.apc.Code2D.resource.c2d.ui.IC2dBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof nl.utwente.apc.Code2D.resource.c2d.IC2dTextResource)) {
					return false;
				}
				nl.utwente.apc.Code2D.resource.c2d.IC2dTextResource textResource = (nl.utwente.apc.Code2D.resource.c2d.IC2dTextResource) resource;
				nl.utwente.apc.Code2D.resource.c2d.IC2dLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
