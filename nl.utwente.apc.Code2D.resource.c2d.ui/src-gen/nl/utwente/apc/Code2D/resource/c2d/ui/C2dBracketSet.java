...
public class C2dBracketSet {
	...
	private java.util.ArrayList<nl.utwente.apc.Code2D.resource.c2d.IC2dBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements nl.utwente.apc.Code2D.resource.c2d.IC2dBracketPair {
	 ...
	 */
	private class ClosingListener implements nl.utwente.apc.Code2D.resource.c2d.ui.IC2dBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				nl.utwente.apc.Code2D.resource.c2d.IC2dBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public C2dBracketSet(nl.utwente.apc.Code2D.resource.c2d.ui.C2dEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new nl.utwente.apc.Code2D.resource.c2d.mopp.C2dMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<nl.utwente.apc.Code2D.resource.c2d.IC2dBracketPair>();
	 ...
	 */
	public nl.utwente.apc.Code2D.resource.c2d.IC2dBracketPair getBracketPair(String opening, String closing) {
		for (nl.utwente.apc.Code2D.resource.c2d.IC2dBracketPair bracketPair : bracketPairs) {
	...
	public nl.utwente.apc.Code2D.resource.c2d.IC2dBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(nl.utwente.apc.Code2D.resource.c2d.IC2dBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + nl.utwente.apc.Code2D.resource.c2d.ui.C2dPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public nl.utwente.apc.Code2D.resource.c2d.IC2dBracketPair remove(String opening, String closing) {
		for (nl.utwente.apc.Code2D.resource.c2d.IC2dBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<nl.utwente.apc.Code2D.resource.c2d.IC2dBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, nl.utwente.apc.Code2D.resource.c2d.ui.C2dPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, nl.utwente.apc.Code2D.resource.c2d.ui.C2dPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
