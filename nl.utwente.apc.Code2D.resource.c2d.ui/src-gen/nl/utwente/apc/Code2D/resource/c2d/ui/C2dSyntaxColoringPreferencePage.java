 ...
 */
public class C2dSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public C2dSyntaxColoringPreferencePage() {
		super();
		
		nl.utwente.apc.Code2D.resource.c2d.mopp.C2dMetaInformation metaInformation = new nl.utwente.apc.Code2D.resource.c2d.mopp.C2dMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = nl.utwente.apc.Code2D.resource.c2d.ui.C2dSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, nl.utwente.apc.Code2D.resource.c2d.ui.C2dSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = nl.utwente.apc.Code2D.resource.c2d.ui.C2dSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, nl.utwente.apc.Code2D.resource.c2d.ui.C2dSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = nl.utwente.apc.Code2D.resource.c2d.ui.C2dSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, nl.utwente.apc.Code2D.resource.c2d.ui.C2dSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = nl.utwente.apc.Code2D.resource.c2d.ui.C2dSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, nl.utwente.apc.Code2D.resource.c2d.ui.C2dSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = nl.utwente.apc.Code2D.resource.c2d.ui.C2dSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, nl.utwente.apc.Code2D.resource.c2d.ui.C2dSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = nl.utwente.apc.Code2D.resource.c2d.ui.C2dSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, nl.utwente.apc.Code2D.resource.c2d.ui.C2dSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		nl.utwente.apc.Code2D.resource.c2d.ui.C2dPixelConverter pixelConverter = new nl.utwente.apc.Code2D.resource.c2d.ui.C2dPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof nl.utwente.apc.Code2D.resource.c2d.ui.C2dEditor) {
			nl.utwente.apc.Code2D.resource.c2d.ui.C2dEditor emfTextEditor = (nl.utwente.apc.Code2D.resource.c2d.ui.C2dEditor) editor;
