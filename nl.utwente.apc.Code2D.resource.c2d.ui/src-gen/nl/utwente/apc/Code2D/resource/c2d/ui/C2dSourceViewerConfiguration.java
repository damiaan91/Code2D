 ...
 */
public class C2dSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private nl.utwente.apc.Code2D.resource.c2d.ui.C2dQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public C2dSourceViewerConfiguration(nl.utwente.apc.Code2D.resource.c2d.IC2dResourceProvider resourceProvider, nl.utwente.apc.Code2D.resource.c2d.ui.IC2dAnnotationModelProvider annotationModelProvider, nl.utwente.apc.Code2D.resource.c2d.ui.IC2dBracketHandlerProvider bracketHandlerProvider, nl.utwente.apc.Code2D.resource.c2d.ui.C2dColorManager colorManager) {
		super(nl.utwente.apc.Code2D.resource.c2d.ui.C2dUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new nl.utwente.apc.Code2D.resource.c2d.ui.C2dCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new nl.utwente.apc.Code2D.resource.c2d.ui.C2dTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new nl.utwente.apc.Code2D.resource.c2d.ui.C2dTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new nl.utwente.apc.Code2D.resource.c2d.ui.C2dHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new nl.utwente.apc.Code2D.resource.c2d.ui.C2dQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new nl.utwente.apc.Code2D.resource.c2d.ui.C2dIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
