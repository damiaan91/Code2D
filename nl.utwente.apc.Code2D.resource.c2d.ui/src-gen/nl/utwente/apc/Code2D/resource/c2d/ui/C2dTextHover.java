 ...
 */
public class C2dTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private nl.utwente.apc.Code2D.resource.c2d.IC2dHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final nl.utwente.apc.Code2D.resource.c2d.ui.C2dBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(nl.utwente.apc.Code2D.resource.c2d.ui.C2dBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			nl.utwente.apc.Code2D.resource.c2d.ui.C2dDocBrowserInformationControlInput infoInput = (nl.utwente.apc.Code2D.resource.c2d.ui.C2dDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					nl.utwente.apc.Code2D.resource.c2d.ui.C2dHyperlink hyperlink = new nl.utwente.apc.Code2D.resource.c2d.ui.C2dHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (nl.utwente.apc.Code2D.resource.c2d.ui.C2dBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				nl.utwente.apc.Code2D.resource.c2d.ui.C2dBrowserInformationControl iControl = new nl.utwente.apc.Code2D.resource.c2d.ui.C2dBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof nl.utwente.apc.Code2D.resource.c2d.ui.C2dDocBrowserInformationControlInput) {
							nl.utwente.apc.Code2D.resource.c2d.ui.C2dDocBrowserInformationControlInput input = (nl.utwente.apc.Code2D.resource.c2d.ui.C2dDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (nl.utwente.apc.Code2D.resource.c2d.ui.C2dBrowserInformationControl.isAvailable(parent)) {
				nl.utwente.apc.Code2D.resource.c2d.ui.C2dBrowserInformationControl iControl = new nl.utwente.apc.Code2D.resource.c2d.ui.C2dBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public C2dTextHover(nl.utwente.apc.Code2D.resource.c2d.IC2dResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new nl.utwente.apc.Code2D.resource.c2d.ui.C2dUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((nl.utwente.apc.Code2D.resource.c2d.ui.C2dDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private nl.utwente.apc.Code2D.resource.c2d.ui.C2dDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private nl.utwente.apc.Code2D.resource.c2d.ui.C2dDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, nl.utwente.apc.Code2D.resource.c2d.ui.C2dDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				nl.utwente.apc.Code2D.resource.c2d.ui.C2dHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			nl.utwente.apc.Code2D.resource.c2d.ui.C2dHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			nl.utwente.apc.Code2D.resource.c2d.ui.C2dHTMLPrinter.insertPageProlog(buffer, 0, nl.utwente.apc.Code2D.resource.c2d.ui.C2dTextHover.getStyleSheet());
			nl.utwente.apc.Code2D.resource.c2d.ui.C2dHTMLPrinter.addPageEpilog(buffer);
			return new nl.utwente.apc.Code2D.resource.c2d.ui.C2dDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = nl.utwente.apc.Code2D.resource.c2d.ui.C2dHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(nl.utwente.apc.Code2D.resource.c2d.ui.C2dUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return nl.utwente.apc.Code2D.resource.c2d.util.C2dStreamUtil.getContent(styleSheetURL.openStream());
