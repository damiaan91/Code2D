...
public class C2dNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private nl.utwente.apc.Code2D.resource.c2d.ui.C2dNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public C2dNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new nl.utwente.apc.Code2D.resource.c2d.ui.C2dNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			nl.utwente.apc.Code2D.resource.c2d.ui.C2dUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			nl.utwente.apc.Code2D.resource.c2d.ui.C2dUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new nl.utwente.apc.Code2D.resource.c2d.mopp.C2dMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new nl.utwente.apc.Code2D.resource.c2d.mopp.C2dMetaInformation().getSyntaxName();
	}
