 ...
 */
public class C2dLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new nl.utwente.apc.Code2D.resource.c2d.mopp.C2dMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(nl.utwente.apc.Code2D.resource.c2d.launch.C2dLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			nl.utwente.apc.Code2D.resource.c2d.mopp.C2dPlugin.logError("Exception while launching selection", e);
		}
	}
