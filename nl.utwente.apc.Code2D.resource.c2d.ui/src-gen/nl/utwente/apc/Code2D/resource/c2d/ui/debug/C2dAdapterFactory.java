...
public class C2dAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new nl.utwente.apc.Code2D.resource.c2d.mopp.C2dMetaInformation().getSyntaxName())) {
					return new nl.utwente.apc.Code2D.resource.c2d.ui.debug.C2dLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebugVariable) {
			final nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebugVariable variable = (nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebugVariable) {
			final nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebugVariable variable = (nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebugValue castedValue = (nl.utwente.apc.Code2D.resource.c2d.debug.C2dDebugValue) value;
