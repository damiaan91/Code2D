...
public class C2dOutlinePageTreeViewerComparator extends org.eclipse.jface.viewers.ViewerComparator {
	...
	public int compare(org.eclipse.jface.viewers.Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof org.eclipse.emf.ecore.EObject && o2 instanceof org.eclipse.emf.ecore.EObject) {
			...
			nl.utwente.apc.Code2D.resource.c2d.IC2dNameProvider nameProvider = new nl.utwente.apc.Code2D.resource.c2d.mopp.C2dMetaInformation().createNameProvider();
