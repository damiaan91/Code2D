 ...
 */
public class C2dOutlinePage extends org.eclipse.ui.part.Page implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.ui.views.contentoutline.IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "nl.utwente.apc.Code2D.resource.c2d.ui.outlinecontext";
	...
	public C2dOutlinePage(nl.utwente.apc.Code2D.resource.c2d.IC2dResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(org.eclipse.swt.widgets.Composite parent) {
		treeViewer = new nl.utwente.apc.Code2D.resource.c2d.ui.C2dOutlinePageTreeViewer(parent, org.eclipse.swt.SWT.MULTI | org.eclipse.swt.SWT.H_SCROLL | org.eclipse.swt.SWT.V_SCROLL);
		...
		treeViewer.setComparator(new nl.utwente.apc.Code2D.resource.c2d.ui.C2dOutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("nl.utwente.apc.Code2D.resource.c2d.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		java.util.List<org.eclipse.jface.action.IAction> actions = new nl.utwente.apc.Code2D.resource.c2d.ui.C2dOutlinePageActionProvider().getActions(treeViewer);
