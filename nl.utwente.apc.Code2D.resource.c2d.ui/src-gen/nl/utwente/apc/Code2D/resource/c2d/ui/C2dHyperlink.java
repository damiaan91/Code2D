 ...
 */
public class C2dHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public C2dHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				nl.utwente.apc.Code2D.resource.c2d.mopp.C2dPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
