 ...
 */
public class C2dHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static nl.utwente.apc.Code2D.resource.c2d.ui.C2dPositionHelper positionHelper = new nl.utwente.apc.Code2D.resource.c2d.ui.C2dPositionHelper();
	...
	private nl.utwente.apc.Code2D.resource.c2d.ui.C2dTokenScanner scanner;
	...
	private nl.utwente.apc.Code2D.resource.c2d.ui.C2dEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private nl.utwente.apc.Code2D.resource.c2d.ui.C2dOccurrence occurrence;
	private nl.utwente.apc.Code2D.resource.c2d.ui.C2dBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, nl.utwente.apc.Code2D.resource.c2d.IC2dBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public C2dHighlighting(nl.utwente.apc.Code2D.resource.c2d.IC2dTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, nl.utwente.apc.Code2D.resource.c2d.ui.C2dColorManager colorManager, nl.utwente.apc.Code2D.resource.c2d.ui.C2dEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = nl.utwente.apc.Code2D.resource.c2d.ui.C2dUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new nl.utwente.apc.Code2D.resource.c2d.ui.C2dTokenScanner(textResource, colorManager);
		occurrence = new nl.utwente.apc.Code2D.resource.c2d.ui.C2dOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new nl.utwente.apc.Code2D.resource.c2d.ui.C2dBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(nl.utwente.apc.Code2D.resource.c2d.ui.C2dPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, nl.utwente.apc.Code2D.resource.c2d.ui.C2dPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(nl.utwente.apc.Code2D.resource.c2d.ui.C2dEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, nl.utwente.apc.Code2D.resource.c2d.ui.C2dPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, nl.utwente.apc.Code2D.resource.c2d.ui.C2dPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(nl.utwente.apc.Code2D.resource.c2d.ui.C2dPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new nl.utwente.apc.Code2D.resource.c2d.ui.C2dEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
