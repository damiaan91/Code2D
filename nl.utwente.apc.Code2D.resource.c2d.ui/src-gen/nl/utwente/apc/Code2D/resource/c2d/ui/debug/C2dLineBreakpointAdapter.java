 ...
 * 
 */
package nl.utwente.apc.Code2D.resource.c2d.ui.debug;

public class C2dLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(nl.utwente.apc.Code2D.resource.c2d.mopp.C2dPlugin.DEBUG_MODEL_ID);
			...
			nl.utwente.apc.Code2D.resource.c2d.debug.C2dLineBreakpoint lineBreakpoint = new nl.utwente.apc.Code2D.resource.c2d.debug.C2dLineBreakpoint(resource, lineNumber + 1);
	...
	private org.eclipse.ui.texteditor.ITextEditor getEditor(org.eclipse.ui.IWorkbenchPart part) {
		if (part instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new nl.utwente.apc.Code2D.resource.c2d.mopp.C2dMetaInformation().getSyntaxName())) {
					return editorPart;
				}
			}
		}
