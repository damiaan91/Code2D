 ...
 */
public class C2dCodeFoldingManager {
	
	private class FoldingUpdateListener implements nl.utwente.apc.Code2D.resource.c2d.IC2dBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(nl.utwente.apc.Code2D.resource.c2d.ui.C2dEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof nl.utwente.apc.Code2D.resource.c2d.ui.C2dEditor) {
				nl.utwente.apc.Code2D.resource.c2d.ui.C2dEditor editor = (nl.utwente.apc.Code2D.resource.c2d.ui.C2dEditor) workbenchPart;
	...
	protected nl.utwente.apc.Code2D.resource.c2d.ui.C2dEditor editor;
	 ...
	 */
	public C2dCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,nl.utwente.apc.Code2D.resource.c2d.ui.C2dEditor textEditor) {
	...
	private void addCloseListener(final nl.utwente.apc.Code2D.resource.c2d.ui.C2dEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			nl.utwente.apc.Code2D.resource.c2d.ui.C2dUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		nl.utwente.apc.Code2D.resource.c2d.IC2dTextResource textResource = (nl.utwente.apc.Code2D.resource.c2d.IC2dTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
