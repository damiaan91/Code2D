 ...
 * olInput</code>.
 */
public class C2DocBrowserInformationControlInput {
	
	private final C2DocBrowserInformationControlInput fPrevious;
	private C2DocBrowserInformationControlInput fNext;
	 ...
	 */
	public C2DocBrowserInformationControlInput(C2DocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public C2DocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public C2DocBrowserInformationControlInput getNext() {
		return fNext;
	}
