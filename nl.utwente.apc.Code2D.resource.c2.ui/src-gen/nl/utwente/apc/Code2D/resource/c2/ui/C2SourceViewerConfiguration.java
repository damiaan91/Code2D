 ...
 */
public class C2SourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private nl.utwente.apc.Code2D.resource.c2.ui.C2QuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public C2SourceViewerConfiguration(nl.utwente.apc.Code2D.resource.c2.IC2ResourceProvider resourceProvider, nl.utwente.apc.Code2D.resource.c2.ui.IC2AnnotationModelProvider annotationModelProvider, nl.utwente.apc.Code2D.resource.c2.ui.IC2BracketHandlerProvider bracketHandlerProvider, nl.utwente.apc.Code2D.resource.c2.ui.C2ColorManager colorManager) {
		super(nl.utwente.apc.Code2D.resource.c2.ui.C2UIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new nl.utwente.apc.Code2D.resource.c2.ui.C2CompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new nl.utwente.apc.Code2D.resource.c2.ui.C2TokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new nl.utwente.apc.Code2D.resource.c2.ui.C2TextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new nl.utwente.apc.Code2D.resource.c2.ui.C2HyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new nl.utwente.apc.Code2D.resource.c2.ui.C2QuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new nl.utwente.apc.Code2D.resource.c2.ui.C2IgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
