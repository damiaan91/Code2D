 ...
 */
public class C2Hyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public C2Hyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				nl.utwente.apc.Code2D.resource.c2.mopp.C2Plugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
