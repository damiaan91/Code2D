 ...
 */
public class C2BackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final nl.utwente.apc.Code2D.resource.c2.IC2TextResource resource, final nl.utwente.apc.Code2D.resource.c2.ui.C2Editor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final nl.utwente.apc.Code2D.resource.c2.IC2TextResource resource, final nl.utwente.apc.Code2D.resource.c2.ui.C2Editor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final nl.utwente.apc.Code2D.resource.c2.IC2TextResource resource, final nl.utwente.apc.Code2D.resource.c2.ui.C2Editor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof nl.utwente.apc.Code2D.resource.c2.mopp.C2Resource) {
							nl.utwente.apc.Code2D.resource.c2.mopp.C2Resource concreteResource = (nl.utwente.apc.Code2D.resource.c2.mopp.C2Resource) resource;
