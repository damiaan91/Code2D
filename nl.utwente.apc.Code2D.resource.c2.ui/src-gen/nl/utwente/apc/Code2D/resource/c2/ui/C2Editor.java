...
/**
 * A text editor for 'c2' models.
 * <p>
 * This editor has id <code>nl.utwente.apc.Code2D.resource.c2.ui.C2Editor</code>
 * The editor's context menu has id
 * <code>nl.utwente.apc.Code2D.resource.c2.EditorContext</code>.
 * The editor's ruler context menu has id
 * <code>nl.utwente.apc.Code2D.resource.c2.EditorRuler</code>.
 * </p>
 */
public class C2Editor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, nl.utwente.apc.Code2D.resource.c2.IC2ResourceProvider, nl.utwente.apc.Code2D.resource.c2.ui.IC2BracketHandlerProvider, nl.utwente.apc.Code2D.resource.c2.ui.IC2AnnotationModelProvider {
	
	private nl.utwente.apc.Code2D.resource.c2.ui.C2Highlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private nl.utwente.apc.Code2D.resource.c2.ui.C2CodeFoldingManager codeFoldingManager;
	private nl.utwente.apc.Code2D.resource.c2.ui.C2BackgroundParsingStrategy bgParsingStrategy = new nl.utwente.apc.Code2D.resource.c2.ui.C2BackgroundParsingStrategy();
	private java.util.Collection<nl.utwente.apc.Code2D.resource.c2.IC2BackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<nl.utwente.apc.Code2D.resource.c2.IC2BackgroundParsingListener>();
	private nl.utwente.apc.Code2D.resource.c2.ui.C2ColorManager colorManager = new nl.utwente.apc.Code2D.resource.c2.ui.C2ColorManager();
	private nl.utwente.apc.Code2D.resource.c2.ui.C2OutlinePage outlinePage;
	...
	private nl.utwente.apc.Code2D.resource.c2.ui.C2PropertySheetPage propertySheetPage;
	...
	private nl.utwente.apc.Code2D.resource.c2.ui.IC2BracketHandler bracketHandler;
	...
	public C2Editor() {
		super();
		setSourceViewerConfiguration(new nl.utwente.apc.Code2D.resource.c2.ui.C2SourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), C2Editor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								nl.utwente.apc.Code2D.resource.c2.IC2TextResource currentResource = getResource();
				...
				nl.utwente.apc.Code2D.resource.c2.ui.C2UIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("nl.utwente.apc.Code2D.resource.c2.EditorContext");
		setRulerContextMenuId("nl.utwente.apc.Code2D.resource.c2.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new nl.utwente.apc.Code2D.resource.c2.ui.C2Highlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new nl.utwente.apc.Code2D.resource.c2.ui.C2CodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		nl.utwente.apc.Code2D.resource.c2.mopp.C2Nature.activate(inputFile.getProject());
		...
		nl.utwente.apc.Code2D.resource.c2.IC2TextResource loadedResource = (nl.utwente.apc.Code2D.resource.c2.IC2TextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				nl.utwente.apc.Code2D.resource.c2.IC2TextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof nl.utwente.apc.Code2D.resource.c2.IC2TextResource) {
					setResource((nl.utwente.apc.Code2D.resource.c2.IC2TextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					nl.utwente.apc.Code2D.resource.c2.ui.C2UIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the C2Editor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				nl.utwente.apc.Code2D.resource.c2.ui.C2UIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(nl.utwente.apc.Code2D.resource.c2.IC2TextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new nl.utwente.apc.Code2D.resource.c2.ui.C2OutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new nl.utwente.apc.Code2D.resource.c2.ui.C2PropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			nl.utwente.apc.Code2D.resource.c2.IC2TextResource textResource = (nl.utwente.apc.Code2D.resource.c2.IC2TextResource) element.eResource();
			nl.utwente.apc.Code2D.resource.c2.IC2LocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			nl.utwente.apc.Code2D.resource.c2.IC2TextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				nl.utwente.apc.Code2D.resource.c2.IC2TextToken token = lexer.getNextToken();
			...
			nl.utwente.apc.Code2D.resource.c2.ui.C2UIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!C2Editor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(nl.utwente.apc.Code2D.resource.c2.IC2BackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (nl.utwente.apc.Code2D.resource.c2.IC2BackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public nl.utwente.apc.Code2D.resource.c2.ui.IC2BracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(nl.utwente.apc.Code2D.resource.c2.ui.IC2BracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof nl.utwente.apc.Code2D.resource.c2.IC2TextResource)) {
					return false;
				}
				nl.utwente.apc.Code2D.resource.c2.IC2TextResource textResource = (nl.utwente.apc.Code2D.resource.c2.IC2TextResource) resource;
				nl.utwente.apc.Code2D.resource.c2.IC2LocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
