 ...
 */
public class C2LaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new nl.utwente.apc.Code2D.resource.c2.mopp.C2MetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(nl.utwente.apc.Code2D.resource.c2.launch.C2LaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			nl.utwente.apc.Code2D.resource.c2.mopp.C2Plugin.logError("Exception while launching selection", e);
		}
	}
