 ...
 */
public class C2Highlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static nl.utwente.apc.Code2D.resource.c2.ui.C2PositionHelper positionHelper = new nl.utwente.apc.Code2D.resource.c2.ui.C2PositionHelper();
	...
	private nl.utwente.apc.Code2D.resource.c2.ui.C2TokenScanner scanner;
	...
	private nl.utwente.apc.Code2D.resource.c2.ui.C2Editor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private nl.utwente.apc.Code2D.resource.c2.ui.C2Occurrence occurrence;
	private nl.utwente.apc.Code2D.resource.c2.ui.C2BracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, nl.utwente.apc.Code2D.resource.c2.IC2BackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public C2Highlighting(nl.utwente.apc.Code2D.resource.c2.IC2TextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, nl.utwente.apc.Code2D.resource.c2.ui.C2ColorManager colorManager, nl.utwente.apc.Code2D.resource.c2.ui.C2Editor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = nl.utwente.apc.Code2D.resource.c2.ui.C2UIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new nl.utwente.apc.Code2D.resource.c2.ui.C2TokenScanner(textResource, colorManager);
		occurrence = new nl.utwente.apc.Code2D.resource.c2.ui.C2Occurrence(textResource, sourceviewer, scanner);
		bracketSet = new nl.utwente.apc.Code2D.resource.c2.ui.C2BracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(nl.utwente.apc.Code2D.resource.c2.ui.C2PreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, nl.utwente.apc.Code2D.resource.c2.ui.C2PreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(nl.utwente.apc.Code2D.resource.c2.ui.C2Editor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, nl.utwente.apc.Code2D.resource.c2.ui.C2PositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, nl.utwente.apc.Code2D.resource.c2.ui.C2PositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(nl.utwente.apc.Code2D.resource.c2.ui.C2PositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new nl.utwente.apc.Code2D.resource.c2.ui.C2EObjectSelection(selectedEObject, false));
				}
			}
		});
	}
