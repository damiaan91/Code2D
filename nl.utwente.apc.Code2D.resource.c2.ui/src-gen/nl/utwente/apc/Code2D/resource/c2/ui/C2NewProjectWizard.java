 ...
 */
public class C2NewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new nl.utwente.apc.Code2D.resource.c2.mopp.C2MetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("nl.utwente.apc.Code2D.resource.c2.ui");
							...
							String natureID = nl.utwente.apc.Code2D.resource.c2.mopp.C2Nature.NATURE_ID;
							...
							for (String builderID : nl.utwente.apc.Code2D.resource.c2.mopp.C2Nature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								nl.utwente.apc.Code2D.resource.c2.mopp.C2MetaInformation info = new nl.utwente.apc.Code2D.resource.c2.mopp.C2MetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = nl.utwente.apc.Code2D.resource.c2.ui.C2UIPlugin.getDefault().getBundle();
