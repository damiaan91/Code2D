...
public class C2OutlinePageTreeViewerComparator extends org.eclipse.jface.viewers.ViewerComparator {
	...
	public int compare(org.eclipse.jface.viewers.Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof org.eclipse.emf.ecore.EObject && o2 instanceof org.eclipse.emf.ecore.EObject) {
			...
			nl.utwente.apc.Code2D.resource.c2.IC2NameProvider nameProvider = new nl.utwente.apc.Code2D.resource.c2.mopp.C2MetaInformation().createNameProvider();
