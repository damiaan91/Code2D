 ...
 */
public class C2NewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public C2NewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new c2 file");
