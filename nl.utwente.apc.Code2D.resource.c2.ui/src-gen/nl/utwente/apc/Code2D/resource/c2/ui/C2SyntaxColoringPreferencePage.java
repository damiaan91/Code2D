 ...
 */
public class C2SyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public C2SyntaxColoringPreferencePage() {
		super();
		
		nl.utwente.apc.Code2D.resource.c2.mopp.C2MetaInformation metaInformation = new nl.utwente.apc.Code2D.resource.c2.mopp.C2MetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = nl.utwente.apc.Code2D.resource.c2.ui.C2SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, nl.utwente.apc.Code2D.resource.c2.ui.C2SyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = nl.utwente.apc.Code2D.resource.c2.ui.C2SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, nl.utwente.apc.Code2D.resource.c2.ui.C2SyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = nl.utwente.apc.Code2D.resource.c2.ui.C2SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, nl.utwente.apc.Code2D.resource.c2.ui.C2SyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = nl.utwente.apc.Code2D.resource.c2.ui.C2SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, nl.utwente.apc.Code2D.resource.c2.ui.C2SyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = nl.utwente.apc.Code2D.resource.c2.ui.C2SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, nl.utwente.apc.Code2D.resource.c2.ui.C2SyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = nl.utwente.apc.Code2D.resource.c2.ui.C2SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, nl.utwente.apc.Code2D.resource.c2.ui.C2SyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		nl.utwente.apc.Code2D.resource.c2.ui.C2PixelConverter pixelConverter = new nl.utwente.apc.Code2D.resource.c2.ui.C2PixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof nl.utwente.apc.Code2D.resource.c2.ui.C2Editor) {
			nl.utwente.apc.Code2D.resource.c2.ui.C2Editor emfTextEditor = (nl.utwente.apc.Code2D.resource.c2.ui.C2Editor) editor;
