 ...
 */
public class C2PreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(nl.utwente.apc.Code2D.resource.c2.ui.C2UIPlugin.getDefault().getPreferenceStore());
		setDescription("C2 Text Editor Preferences");
	}
