 ...
 * a specified depth.
 */
public class C2OutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public C2OutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = nl.utwente.apc.Code2D.resource.c2.util.C2StringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof nl.utwente.apc.Code2D.resource.c2.ui.C2EObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			nl.utwente.apc.Code2D.resource.c2.mopp.C2Plugin.logError("Exception while refreshing outline view", e);
		}
	}
