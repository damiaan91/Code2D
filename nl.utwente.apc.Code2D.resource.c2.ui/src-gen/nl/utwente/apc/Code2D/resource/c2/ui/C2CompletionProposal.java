 ...
 */
public class C2CompletionProposal implements java.lang.Comparable<C2CompletionProposal> {
	 ...
	 */
	private nl.utwente.apc.Code2D.resource.c2.mopp.C2ExpectedTerminal expectedTerminal;
	...
	public C2CompletionProposal(nl.utwente.apc.Code2D.resource.c2.mopp.C2ExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public C2CompletionProposal(nl.utwente.apc.Code2D.resource.c2.mopp.C2ExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public C2CompletionProposal(nl.utwente.apc.Code2D.resource.c2.mopp.C2ExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public nl.utwente.apc.Code2D.resource.c2.mopp.C2ExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof C2CompletionProposal) {
			C2CompletionProposal other = (C2CompletionProposal) object;
	...
	public int compareTo(C2CompletionProposal object) {
		if (object instanceof C2CompletionProposal) {
			C2CompletionProposal other = (C2CompletionProposal) object;
