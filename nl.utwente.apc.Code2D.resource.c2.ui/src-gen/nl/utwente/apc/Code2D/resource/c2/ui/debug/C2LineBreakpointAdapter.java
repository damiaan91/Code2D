...
public class C2LineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(nl.utwente.apc.Code2D.resource.c2.mopp.C2Plugin.DEBUG_MODEL_ID);
			...
			nl.utwente.apc.Code2D.resource.c2.debug.C2LineBreakpoint lineBreakpoint = new nl.utwente.apc.Code2D.resource.c2.debug.C2LineBreakpoint(resource, lineNumber + 1);
