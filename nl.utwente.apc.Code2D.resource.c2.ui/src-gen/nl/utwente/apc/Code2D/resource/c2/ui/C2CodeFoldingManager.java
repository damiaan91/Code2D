 ...
 */
public class C2CodeFoldingManager {
	
	private class FoldingUpdateListener implements nl.utwente.apc.Code2D.resource.c2.IC2BackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(nl.utwente.apc.Code2D.resource.c2.ui.C2Editor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof nl.utwente.apc.Code2D.resource.c2.ui.C2Editor) {
				nl.utwente.apc.Code2D.resource.c2.ui.C2Editor editor = (nl.utwente.apc.Code2D.resource.c2.ui.C2Editor) workbenchPart;
	...
	protected nl.utwente.apc.Code2D.resource.c2.ui.C2Editor editor;
	 ...
	 */
	public C2CodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,nl.utwente.apc.Code2D.resource.c2.ui.C2Editor textEditor) {
	...
	private void addCloseListener(final nl.utwente.apc.Code2D.resource.c2.ui.C2Editor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			nl.utwente.apc.Code2D.resource.c2.ui.C2UIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		nl.utwente.apc.Code2D.resource.c2.IC2TextResource textResource = (nl.utwente.apc.Code2D.resource.c2.IC2TextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
