...
public class C2PropertyTester extends org.eclipse.core.expressions.PropertyTester {
	...
	private boolean hasMatchingURI(org.eclipse.core.resources.IResource resource) {
		...
		return path.endsWith("." + new nl.utwente.apc.Code2D.resource.c2.mopp.C2MetaInformation().getSyntaxName());
	}
