 ...
 */
public class C2TextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private nl.utwente.apc.Code2D.resource.c2.IC2HoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final nl.utwente.apc.Code2D.resource.c2.ui.C2BrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(nl.utwente.apc.Code2D.resource.c2.ui.C2BrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			nl.utwente.apc.Code2D.resource.c2.ui.C2DocBrowserInformationControlInput infoInput = (nl.utwente.apc.Code2D.resource.c2.ui.C2DocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					nl.utwente.apc.Code2D.resource.c2.ui.C2Hyperlink hyperlink = new nl.utwente.apc.Code2D.resource.c2.ui.C2Hyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (nl.utwente.apc.Code2D.resource.c2.ui.C2BrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				nl.utwente.apc.Code2D.resource.c2.ui.C2BrowserInformationControl iControl = new nl.utwente.apc.Code2D.resource.c2.ui.C2BrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof nl.utwente.apc.Code2D.resource.c2.ui.C2DocBrowserInformationControlInput) {
							nl.utwente.apc.Code2D.resource.c2.ui.C2DocBrowserInformationControlInput input = (nl.utwente.apc.Code2D.resource.c2.ui.C2DocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (nl.utwente.apc.Code2D.resource.c2.ui.C2BrowserInformationControl.isAvailable(parent)) {
				nl.utwente.apc.Code2D.resource.c2.ui.C2BrowserInformationControl iControl = new nl.utwente.apc.Code2D.resource.c2.ui.C2BrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public C2TextHover(nl.utwente.apc.Code2D.resource.c2.IC2ResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new nl.utwente.apc.Code2D.resource.c2.ui.C2UIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((nl.utwente.apc.Code2D.resource.c2.ui.C2DocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private nl.utwente.apc.Code2D.resource.c2.ui.C2DocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private nl.utwente.apc.Code2D.resource.c2.ui.C2DocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, nl.utwente.apc.Code2D.resource.c2.ui.C2DocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				nl.utwente.apc.Code2D.resource.c2.ui.C2HTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			nl.utwente.apc.Code2D.resource.c2.ui.C2HTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			nl.utwente.apc.Code2D.resource.c2.ui.C2HTMLPrinter.insertPageProlog(buffer, 0, nl.utwente.apc.Code2D.resource.c2.ui.C2TextHover.getStyleSheet());
			nl.utwente.apc.Code2D.resource.c2.ui.C2HTMLPrinter.addPageEpilog(buffer);
			return new nl.utwente.apc.Code2D.resource.c2.ui.C2DocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = nl.utwente.apc.Code2D.resource.c2.ui.C2HTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(nl.utwente.apc.Code2D.resource.c2.ui.C2UIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return nl.utwente.apc.Code2D.resource.c2.util.C2StreamUtil.getContent(styleSheetURL.openStream());
