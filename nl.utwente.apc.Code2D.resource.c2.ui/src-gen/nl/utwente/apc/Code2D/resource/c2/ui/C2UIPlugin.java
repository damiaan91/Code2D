 ...
 */
public class C2UIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "nl.utwente.apc.Code2D.resource.c2.ui";
	public static final String EDITOR_ID = "nl.utwente.apc.Code2D.resource.c2.ui.C2Editor";
	...
	private static C2UIPlugin plugin;
	...
	public static C2UIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, C2UIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, C2UIPlugin.PLUGIN_ID, message);
		}
		final C2UIPlugin pluginInstance = C2UIPlugin.getDefault();
