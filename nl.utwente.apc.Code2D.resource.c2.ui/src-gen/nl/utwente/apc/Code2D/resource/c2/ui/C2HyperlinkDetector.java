 ...
 * hovers, is a proxy.
 */
public class C2HyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public C2HyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (nl.utwente.apc.Code2D.resource.c2.IC2TextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new nl.utwente.apc.Code2D.resource.c2.ui.C2Hyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
