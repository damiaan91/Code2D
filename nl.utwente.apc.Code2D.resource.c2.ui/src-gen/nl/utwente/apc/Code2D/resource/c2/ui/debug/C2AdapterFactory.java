 ...
 * 
 */
package nl.utwente.apc.Code2D.resource.c2.ui.debug;

@SuppressWarnings("restriction")
public class C2AdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new nl.utwente.apc.Code2D.resource.c2.mopp.C2MetaInformation().getSyntaxName())) {
					return new nl.utwente.apc.Code2D.resource.c2.ui.debug.C2LineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof nl.utwente.apc.Code2D.resource.c2.debug.C2DebugVariable) {
			final nl.utwente.apc.Code2D.resource.c2.debug.C2DebugVariable variable = (nl.utwente.apc.Code2D.resource.c2.debug.C2DebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof nl.utwente.apc.Code2D.resource.c2.debug.C2DebugVariable) {
			final nl.utwente.apc.Code2D.resource.c2.debug.C2DebugVariable variable = (nl.utwente.apc.Code2D.resource.c2.debug.C2DebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							nl.utwente.apc.Code2D.resource.c2.debug.C2DebugValue castedValue = (nl.utwente.apc.Code2D.resource.c2.debug.C2DebugValue) value;
