 ...
 * @since 3.2
 */
public class C2BrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private nl.utwente.apc.Code2D.resource.c2.ui.C2DocBrowserInformationControlInput fInput;
	 ...
	 */
	public C2BrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public C2BrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public C2BrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof nl.utwente.apc.Code2D.resource.c2.ui.C2DocBrowserInformationControlInput);
		...
		fInput= (nl.utwente.apc.Code2D.resource.c2.ui.C2DocBrowserInformationControlInput) input;
		...
		nl.utwente.apc.Code2D.resource.c2.ui.C2HTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = nl.utwente.apc.Code2D.resource.c2.ui.C2HTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public nl.utwente.apc.Code2D.resource.c2.ui.C2DocBrowserInformationControlInput getInput() {
		return fInput;
	}
