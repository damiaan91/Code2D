...
public class C2BracketSet {
	...
	private java.util.ArrayList<nl.utwente.apc.Code2D.resource.c2.IC2BracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements nl.utwente.apc.Code2D.resource.c2.IC2BracketPair {
	 ...
	 */
	private class ClosingListener implements nl.utwente.apc.Code2D.resource.c2.ui.IC2BracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				nl.utwente.apc.Code2D.resource.c2.IC2BracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public C2BracketSet(nl.utwente.apc.Code2D.resource.c2.ui.C2Editor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new nl.utwente.apc.Code2D.resource.c2.mopp.C2MetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<nl.utwente.apc.Code2D.resource.c2.IC2BracketPair>();
	 ...
	 */
	public nl.utwente.apc.Code2D.resource.c2.IC2BracketPair getBracketPair(String opening, String closing) {
		for (nl.utwente.apc.Code2D.resource.c2.IC2BracketPair bracketPair : bracketPairs) {
	...
	public nl.utwente.apc.Code2D.resource.c2.IC2BracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(nl.utwente.apc.Code2D.resource.c2.IC2BracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + nl.utwente.apc.Code2D.resource.c2.ui.C2PreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public nl.utwente.apc.Code2D.resource.c2.IC2BracketPair remove(String opening, String closing) {
		for (nl.utwente.apc.Code2D.resource.c2.IC2BracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<nl.utwente.apc.Code2D.resource.c2.IC2BracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, nl.utwente.apc.Code2D.resource.c2.ui.C2PositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, nl.utwente.apc.Code2D.resource.c2.ui.C2PositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
