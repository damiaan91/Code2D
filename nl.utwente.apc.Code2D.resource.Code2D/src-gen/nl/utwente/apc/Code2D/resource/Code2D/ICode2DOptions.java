 ...
 */
public interface ICode2DOptions {
	
	/**
	 * The key for the option to provide a stream pre-processor.
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DMetaInformation().getResourcePostProcessorProviderOptionKey();
