 ...
 */
public class Code2DDefaultTokenResolver implements nl.utwente.apc.Code2D.resource.Code2D.ICode2DTokenResolver {
	 ...
	 */
	public Code2DDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public Code2DDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, nl.utwente.apc.Code2D.resource.Code2D.ICode2DTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : nl.utwente.apc.Code2D.resource.Code2D.grammar.Code2DGrammarInformationProvider.INSTANCE.getKeywords()) {
