...
/**
 * Code2DLayoutInformation objects are used to store layout information that is
 ...
 * Code2DLayoutInformations are aggregated in LayoutInformationAdapters. One
 * Code2DLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class Code2DLayoutInformation {
	 ...
	 */
	private final nl.utwente.apc.Code2D.resource.Code2D.grammar.Code2DSyntaxElement syntaxElement;
	...
	public Code2DLayoutInformation(nl.utwente.apc.Code2D.resource.Code2D.grammar.Code2DSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public nl.utwente.apc.Code2D.resource.Code2D.grammar.Code2DSyntaxElement getSyntaxElement() {
