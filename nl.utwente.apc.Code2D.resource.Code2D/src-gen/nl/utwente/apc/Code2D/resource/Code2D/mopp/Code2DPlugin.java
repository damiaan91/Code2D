 ...
 */
public class Code2DPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "nl.utwente.apc.Code2D.resource.Code2D";
	/**
	...
	private static Code2DPlugin plugin;
	...
	public static Code2DPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, Code2DPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, Code2DPlugin.PLUGIN_ID, message);
		}
		final Code2DPlugin pluginInstance = Code2DPlugin.getDefault();
