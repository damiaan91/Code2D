...
public class Code2DDebugValue extends nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public Code2DDebugValue(nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
