...
/**
 * A Code2DLayoutInformationAdapter is used to store layout information that is
 ...
 * Code2DLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class Code2DLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DLayoutInformation> layoutInformations = new java.util.ArrayList<nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DLayoutInformation>();
	...
	public java.util.List<nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DLayoutInformation layoutInformation) {
