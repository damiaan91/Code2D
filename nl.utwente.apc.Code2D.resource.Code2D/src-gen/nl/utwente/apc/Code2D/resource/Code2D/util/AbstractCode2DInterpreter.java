 ...
 */
public class AbstractCode2DInterpreter<ResultType, ContextType> {
	
	private java.util.Stack<org.eclipse.emf.ecore.EObject> interpretationStack = new java.util.Stack<org.eclipse.emf.ecore.EObject>();
	private java.util.List<nl.utwente.apc.Code2D.resource.Code2D.ICode2DInterpreterListener> listeners = new java.util.ArrayList<nl.utwente.apc.Code2D.resource.Code2D.ICode2DInterpreterListener>();
	...
	private void notifyListeners(org.eclipse.emf.ecore.EObject element) {
		for (nl.utwente.apc.Code2D.resource.Code2D.ICode2DInterpreterListener listener : listeners) {
	...
	public void addListener(nl.utwente.apc.Code2D.resource.Code2D.ICode2DInterpreterListener newListener) {
		listeners.add(newListener);
	}
	
	public boolean removeListener(nl.utwente.apc.Code2D.resource.Code2D.ICode2DInterpreterListener listener) {
