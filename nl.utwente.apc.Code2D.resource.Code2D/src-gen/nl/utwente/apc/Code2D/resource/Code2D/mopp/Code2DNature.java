...
public class Code2DNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "nl.utwente.apc.Code2D.resource.Code2D.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
