...
public class Code2DStackFrame extends nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugTarget target;
	private String name;
	private int id;
	...
	public Code2DStackFrame(nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = nl.utwente.apc.Code2D.resource.Code2D.util.Code2DStringUtil.decode(data, ',');
	...
	private nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DStackFrame other = (nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DStackFrame) obj;
		if (name == null) {
