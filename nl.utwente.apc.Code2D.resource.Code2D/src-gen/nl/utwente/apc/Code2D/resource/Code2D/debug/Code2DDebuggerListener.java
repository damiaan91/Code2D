 ...
 * code).
 */
public class Code2DDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private nl.utwente.apc.Code2D.resource.Code2D.debug.AbstractCode2DDebuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, nl.utwente.apc.Code2D.resource.Code2D.util.Code2DPair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, nl.utwente.apc.Code2D.resource.Code2D.util.Code2DPair<String, Object>>();
	...
	public Code2DDebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(nl.utwente.apc.Code2D.resource.Code2D.debug.ECode2DDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(nl.utwente.apc.Code2D.resource.Code2D.debug.ECode2DDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(nl.utwente.apc.Code2D.resource.Code2D.debug.ECode2DDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(nl.utwente.apc.Code2D.resource.Code2D.debug.ECode2DDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(nl.utwente.apc.Code2D.resource.Code2D.debug.ECode2DDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(nl.utwente.apc.Code2D.resource.Code2D.debug.ECode2DDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(nl.utwente.apc.Code2D.resource.Code2D.debug.ECode2DDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(nl.utwente.apc.Code2D.resource.Code2D.debug.ECode2DDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = nl.utwente.apc.Code2D.resource.Code2D.util.Code2DStringUtil.encode('#', stack);
				nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugMessage message = new nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugMessage(nl.utwente.apc.Code2D.resource.Code2D.debug.ECode2DDebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(nl.utwente.apc.Code2D.resource.Code2D.debug.ECode2DDebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugMessage message = new nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugMessage(nl.utwente.apc.Code2D.resource.Code2D.debug.ECode2DDebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(nl.utwente.apc.Code2D.resource.Code2D.debug.ECode2DDebugMessageTypes.GET_VARIABLES)) {
				...
				nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugMessage message = new nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugMessage(nl.utwente.apc.Code2D.resource.Code2D.debug.ECode2DDebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return nl.utwente.apc.Code2D.resource.Code2D.util.Code2DStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		nl.utwente.apc.Code2D.resource.Code2D.util.Code2DPair<String, Object> pair = new nl.utwente.apc.Code2D.resource.Code2D.util.Code2DPair<String, Object>(name, value);
	...
	public nl.utwente.apc.Code2D.resource.Code2D.debug.AbstractCode2DDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(nl.utwente.apc.Code2D.resource.Code2D.debug.AbstractCode2DDebuggable debuggable) {
