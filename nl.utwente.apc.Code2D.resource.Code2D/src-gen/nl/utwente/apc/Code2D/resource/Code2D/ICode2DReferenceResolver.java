 ...
 * resolver
 */
public interface ICode2DReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends nl.utwente.apc.Code2D.resource.Code2D.ICode2DConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, nl.utwente.apc.Code2D.resource.Code2D.ICode2DReferenceResolveResult<ReferenceType> result);
