 ...
 * 
 */
package nl.utwente.apc.Code2D.resource.Code2D.launch;

/**
 * A class that provides common methods that are required by launch configuration
 * delegates.
 */
public class Code2DLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends nl.utwente.apc.Code2D.resource.Code2D.util.AbstractCode2DInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, nl.utwente.apc.Code2D.resource.Code2D.util.AbstractCode2DInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebuggableInterpreter<ResultType, ContextType> interpreter = new nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebuggerListener<ResultType, ContextType> debugListener = new nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugProcess process = new nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugProcess(launch);
		launch.addDebugTarget(new nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(nl.utwente.apc.Code2D.resource.Code2D.launch.Code2DLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return nl.utwente.apc.Code2D.resource.Code2D.util.Code2DResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
