 ...
 */
public class Code2DExpectedTerminal {
	...
	private nl.utwente.apc.Code2D.resource.Code2D.ICode2DExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	private nl.utwente.apc.Code2D.resource.Code2D.grammar.Code2DContainmentTrace containmentTrace;
	
	public Code2DExpectedTerminal(org.eclipse.emf.ecore.EObject container, nl.utwente.apc.Code2D.resource.Code2D.ICode2DExpectedElement terminal, int followSetID, nl.utwente.apc.Code2D.resource.Code2D.grammar.Code2DContainmentTrace containmentTrace) {
		super();
	...
	public nl.utwente.apc.Code2D.resource.Code2D.ICode2DExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		...
		Code2DExpectedTerminal otherExpectedTerminal = (Code2DExpectedTerminal) o;
	...
	public nl.utwente.apc.Code2D.resource.Code2D.grammar.Code2DContainmentTrace getContainmentTrace() {
