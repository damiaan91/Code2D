...
/**
 * This is the item provider adapter for a {@link nl.utwente.apc.Code2D.Game} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GameItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Code2DPackage.Literals.GAME__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Code2DPackage.Literals.GAME__GAME_OBJECTS);
			childrenFeatures.add(Code2DPackage.Literals.GAME__GAME_WORLD);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Code2DPackage.Literals.GAME__GAME_OBJECTS,
				 Code2DFactory.eINSTANCE.createPlayer()));

		newChildDescriptors.add
			(createChildParameter
				(Code2DPackage.Literals.GAME__GAME_OBJECTS,
				 Code2DFactory.eINSTANCE.createNPC()));

		newChildDescriptors.add
			(createChildParameter
				(Code2DPackage.Literals.GAME__GAME_OBJECTS,
				 Code2DFactory.eINSTANCE.createItem()));

		newChildDescriptors.add
			(createChildParameter
				(Code2DPackage.Literals.GAME__GAME_OBJECTS,
				 Code2DFactory.eINSTANCE.createTerrain()));

		newChildDescriptors.add
			(createChildParameter
				(Code2DPackage.Literals.GAME__GAME_OBJECTS,
				 Code2DFactory.eINSTANCE.createTrap()));

		newChildDescriptors.add
			(createChildParameter
				(Code2DPackage.Literals.GAME__GAME_OBJECTS,
				 Code2DFactory.eINSTANCE.createScenery()));

		newChildDescriptors.add
			(createChildParameter
				(Code2DPackage.Literals.GAME__GAME_WORLD,
				 Code2DFactory.eINSTANCE.createWorld()));
	}
