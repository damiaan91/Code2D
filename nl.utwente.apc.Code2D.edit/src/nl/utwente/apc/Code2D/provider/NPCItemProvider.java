...
/**
 * This is the item provider adapter for a {@link nl.utwente.apc.Code2D.NPC} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NPC_Behaviour_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NPC_Behaviour_feature", "_UI_NPC_type"),
				 Code2DPackage.Literals.NPC__BEHAVIOUR,
				 true,
				 false,
				 false,
	...
	protected void addExtendsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NPC_Extends_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NPC_Extends_feature", "_UI_NPC_type"),
				 Code2DPackage.Literals.NPC__EXTENDS,
				 true,
				 false,
				 true,
				 null,
