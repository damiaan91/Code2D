 ...
 * a specified depth.
 */
public class Code2DOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public Code2DOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = nl.utwente.apc.Code2D.resource.Code2D.util.Code2DStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DPlugin.logError("Exception while refreshing outline view", e);
		}
	}
