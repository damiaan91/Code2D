...
public class Code2DOutlinePageTreeViewerComparator extends org.eclipse.jface.viewers.ViewerComparator {
	...
	public int compare(org.eclipse.jface.viewers.Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof org.eclipse.emf.ecore.EObject && o2 instanceof org.eclipse.emf.ecore.EObject) {
			...
			nl.utwente.apc.Code2D.resource.Code2D.ICode2DNameProvider nameProvider = new nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DMetaInformation().createNameProvider();
