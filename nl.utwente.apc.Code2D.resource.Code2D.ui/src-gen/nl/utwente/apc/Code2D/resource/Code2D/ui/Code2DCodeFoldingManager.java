 ...
 */
public class Code2DCodeFoldingManager {
	
	private class FoldingUpdateListener implements nl.utwente.apc.Code2D.resource.Code2D.ICode2DBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DEditor) {
				nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DEditor editor = (nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DEditor) workbenchPart;
	...
	protected nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DEditor editor;
	 ...
	 */
	public Code2DCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DEditor textEditor) {
	...
	private void addCloseListener(final nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		nl.utwente.apc.Code2D.resource.Code2D.ICode2DTextResource textResource = (nl.utwente.apc.Code2D.resource.Code2D.ICode2DTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
