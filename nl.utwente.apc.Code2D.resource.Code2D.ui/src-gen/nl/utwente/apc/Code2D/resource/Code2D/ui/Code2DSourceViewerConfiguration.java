 ...
 */
public class Code2DSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public Code2DSourceViewerConfiguration(nl.utwente.apc.Code2D.resource.Code2D.ICode2DResourceProvider resourceProvider, nl.utwente.apc.Code2D.resource.Code2D.ui.ICode2DAnnotationModelProvider annotationModelProvider, nl.utwente.apc.Code2D.resource.Code2D.ui.ICode2DBracketHandlerProvider bracketHandlerProvider, nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DColorManager colorManager) {
		super(nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
