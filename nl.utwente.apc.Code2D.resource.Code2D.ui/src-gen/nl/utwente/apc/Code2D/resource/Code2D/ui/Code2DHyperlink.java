 ...
 */
public class Code2DHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public Code2DHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
