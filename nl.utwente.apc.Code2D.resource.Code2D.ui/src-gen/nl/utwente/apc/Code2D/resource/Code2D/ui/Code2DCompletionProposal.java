 ...
 */
public class Code2DCompletionProposal implements java.lang.Comparable<Code2DCompletionProposal> {
	 ...
	 */
	private nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DExpectedTerminal expectedTerminal;
	...
	public Code2DCompletionProposal(nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public Code2DCompletionProposal(nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
	...
	public nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof Code2DCompletionProposal) {
			Code2DCompletionProposal other = (Code2DCompletionProposal) object;
	...
	public int compareTo(Code2DCompletionProposal object) {
		if (object instanceof Code2DCompletionProposal) {
			Code2DCompletionProposal other = (Code2DCompletionProposal) object;
