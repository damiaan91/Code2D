...
public class Code2DAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DMetaInformation().getSyntaxName())) {
					return new nl.utwente.apc.Code2D.resource.Code2D.ui.debug.Code2DLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugVariable) {
			final nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugVariable variable = (nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugVariable) {
			final nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugVariable variable = (nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugValue castedValue = (nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DDebugValue) value;
