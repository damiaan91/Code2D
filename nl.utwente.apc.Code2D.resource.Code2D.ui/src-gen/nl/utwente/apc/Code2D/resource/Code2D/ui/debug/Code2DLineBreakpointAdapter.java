 ...
 * 
 */
package nl.utwente.apc.Code2D.resource.Code2D.ui.debug;

public class Code2DLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DPlugin.DEBUG_MODEL_ID);
			...
			nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DLineBreakpoint lineBreakpoint = new nl.utwente.apc.Code2D.resource.Code2D.debug.Code2DLineBreakpoint(resource, lineNumber + 1);
	...
	private org.eclipse.ui.texteditor.ITextEditor getEditor(org.eclipse.ui.IWorkbenchPart part) {
		if (part instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DMetaInformation().getSyntaxName())) {
					return editorPart;
				}
			}
		}
