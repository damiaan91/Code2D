 ...
 */
public class Code2DTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	
	private static final String FONT = org.eclipse.jface.resource.JFaceResources.DIALOG_FONT;
	
	private nl.utwente.apc.Code2D.resource.Code2D.ICode2DResourceProvider resourceProvider;
	private nl.utwente.apc.Code2D.resource.Code2D.ICode2DHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DDocBrowserInformationControlInput infoInput = (nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DHyperlink hyperlink = new nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DBrowserInformationControl iControl = new nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DDocBrowserInformationControlInput) {
							nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DDocBrowserInformationControlInput input = (nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DBrowserInformationControl.isAvailable(parent)) {
				nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DBrowserInformationControl iControl = new nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public Code2DTextHover(nl.utwente.apc.Code2D.resource.Code2D.ICode2DResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		nl.utwente.apc.Code2D.resource.Code2D.ICode2DTextResource textResource = resourceProvider.getResource();
	 ...
	 */
	private nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DHTMLPrinter.insertPageProlog(buffer, 0, nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DTextHover.getStyleSheet());
			nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DHTMLPrinter.addPageEpilog(buffer);
			return new nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return nl.utwente.apc.Code2D.resource.Code2D.util.Code2DStreamUtil.getContent(styleSheetURL.openStream());
