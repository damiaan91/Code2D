 ...
 */
public class Code2DBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final nl.utwente.apc.Code2D.resource.Code2D.ICode2DTextResource resource, final nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final nl.utwente.apc.Code2D.resource.Code2D.ICode2DTextResource resource, final nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final nl.utwente.apc.Code2D.resource.Code2D.ICode2DTextResource resource, final nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DResource) {
							nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DResource concreteResource = (nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DResource) resource;
