 ...
 */
public class Code2DNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public Code2DNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new Code2D file");
