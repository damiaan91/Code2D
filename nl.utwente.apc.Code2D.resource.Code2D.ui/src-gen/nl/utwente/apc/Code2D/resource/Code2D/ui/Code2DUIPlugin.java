 ...
 */
public class Code2DUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "nl.utwente.apc.Code2D.resource.Code2D.ui";
	public static final String EDITOR_ID = "nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DEditor";
	...
	private static Code2DUIPlugin plugin;
	
	public Code2DUIPlugin() {
		super();
	}
	...
	public static Code2DUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, Code2DUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, Code2DUIPlugin.PLUGIN_ID, message);
		}
		final Code2DUIPlugin pluginInstance = Code2DUIPlugin.getDefault();
