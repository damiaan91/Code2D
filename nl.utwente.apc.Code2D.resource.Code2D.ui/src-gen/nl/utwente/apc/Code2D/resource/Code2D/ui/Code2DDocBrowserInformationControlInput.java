 ...
 * olInput</code>.
 */
public class Code2DDocBrowserInformationControlInput {
	
	private final Code2DDocBrowserInformationControlInput fPrevious;
	private Code2DDocBrowserInformationControlInput fNext;
	 ...
	 */
	public Code2DDocBrowserInformationControlInput(Code2DDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public Code2DDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public Code2DDocBrowserInformationControlInput getNext() {
		return fNext;
	}
