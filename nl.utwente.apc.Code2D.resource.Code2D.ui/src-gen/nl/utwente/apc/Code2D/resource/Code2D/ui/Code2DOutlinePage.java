 ...
 */
public class Code2DOutlinePage extends org.eclipse.ui.part.Page implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.ui.views.contentoutline.IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "nl.utwente.apc.Code2D.resource.Code2D.ui.outlinecontext";
	...
	public Code2DOutlinePage(nl.utwente.apc.Code2D.resource.Code2D.ICode2DResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(org.eclipse.swt.widgets.Composite parent) {
		treeViewer = new nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DOutlinePageTreeViewer(parent, org.eclipse.swt.SWT.MULTI | org.eclipse.swt.SWT.H_SCROLL | org.eclipse.swt.SWT.V_SCROLL);
		...
		treeViewer.setComparator(new nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DOutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("nl.utwente.apc.Code2D.resource.Code2D.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		java.util.List<org.eclipse.jface.action.IAction> actions = new nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DOutlinePageActionProvider().getActions(treeViewer);
