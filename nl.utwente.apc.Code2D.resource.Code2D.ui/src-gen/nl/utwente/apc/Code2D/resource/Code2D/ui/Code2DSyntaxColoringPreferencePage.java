 ...
 */
public class Code2DSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public Code2DSyntaxColoringPreferencePage() {
		super();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DPixelConverter pixelConverter = new nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DEditor) {
			nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DEditor emfTextEditor = (nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DEditor) editor;
