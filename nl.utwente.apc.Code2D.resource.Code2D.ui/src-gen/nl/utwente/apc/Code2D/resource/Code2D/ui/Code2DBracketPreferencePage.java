 ...
 * </ul>
 */
public class Code2DBracketPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };
	
	private String BRACKETS_COLOR = nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DMetaInformation().getSyntaxName();
	
	private nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DBracketSet bracketsTmp;
	
	/**
	 * Creates a preference page for bracket setting.
	 */
	public Code2DBracketPreferencePage() {
		super();
		
		nl.utwente.apc.Code2D.resource.Code2D.ICode2DMetaInformation metaInformation = new nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DUIPlugin.getDefault().getPreferenceStore());
		setDescription("Define the coloring of matching brackets.");
		
		bracketsTmp = new nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DBracketSet(null, null);
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void handleMatchingBracketsSelection() {
		...
		enableCheckbox.setSelection(getPreferenceStore().getBoolean(		nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		enableClosingInside.setSelection(false);
		matchingBracketsColorButton.setEnabled(getPreferenceStore().getBoolean(		nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		...
		initializeLanguage();
		bracketsTmp.setBrackets(getPreferenceStore().getString(language + nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		...
		bracketsList.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int index : itemIndices) {
					nl.utwente.apc.Code2D.resource.Code2D.ICode2DBracketPair bracketPair = bracketsTmp.getBracketPair(index);
		...
		enableClosingInside.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int idx : itemIndices) {
					nl.utwente.apc.Code2D.resource.Code2D.ICode2DBracketPair bracketPair = bracketsTmp.getBracketPair(idx);
	...
	protected void performDefaults() {
		enableCheckbox.setSelection(getPreferenceStore().getDefaultBoolean(nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		...
		bracketSetTemp.put(language, getPreferenceStore().getDefaultString(language + nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		bracketsTmp.setBrackets(bracketSetTemp.get(language));
		bracketsList.setItems(bracketsTmp.getBracketArray());
		enableClosingInside.setSelection(false);
	}
	...
	private void updateActiveEditor() {
		...
		getPreferenceStore().setValue(nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		getPreferenceStore().setValue(language + nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DPreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
		...
		if (editor != null && editor instanceof nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DEditor) {
			((nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DEditor) editor).invalidateTextRepresentation();
		}
	}
