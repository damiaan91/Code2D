 ...
 * @since 3.2
 */
public class Code2DBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DDocBrowserInformationControlInput fInput;
	 ...
	 */
	public Code2DBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public Code2DBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public Code2DBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DDocBrowserInformationControlInput);
		...
		fInput= (nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DDocBrowserInformationControlInput) input;
		...
		nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public nl.utwente.apc.Code2D.resource.Code2D.ui.Code2DDocBrowserInformationControlInput getInput() {
		return fInput;
	}
