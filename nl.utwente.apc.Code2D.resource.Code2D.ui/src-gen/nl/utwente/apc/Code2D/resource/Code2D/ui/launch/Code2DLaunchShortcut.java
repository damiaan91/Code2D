 ...
 */
public class Code2DLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(nl.utwente.apc.Code2D.resource.Code2D.launch.Code2DLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			nl.utwente.apc.Code2D.resource.Code2D.mopp.Code2DPlugin.logError("Exception while launching selection", e);
		}
	}
